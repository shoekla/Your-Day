...
public class result extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (com.example.calendarquickstart.htmlCodeJ.quotes.contains(userQuote)) {
        }
        else {
            //add to circle
            com.example.calendarquickstart.htmlCodeJ.addToCircle(userQuote);
    ...
    public void onBackPressed() {
        Intent i = new Intent(this, com.example.calendarquickstart.MainActivity.class);
        startActivity(i);
    }
